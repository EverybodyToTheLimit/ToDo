...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --salmon: #369a7e;\n    --salmon-gradient: linear-gradient(90deg, rgba(84,90,92,1) 0%, rgba(54,154,126,1) 60%, rgba(0,212,255,1) 100%);\n    --yellow: #F87575;\n    --green: #B8F2E6;\n    --blue: #545a5c;\n    --blue-highlight: #545a5c83;\n    --grey: #e9e9e9;\n    --grey-highlight: #e9e9e970;\n    --black: #2D2D34;\n    --white: #ffffff;\n}\n\nbody {\n    margin: 0;\n    font-family: 'Tillana', cursive;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.header {\n    background-image: var(--salmon-gradient);\n    height: 60px;\n    font-size: 20px;\n    width: 70%;\n    display: flex;\n    justify-items: flex-start;\n    align-items: center;\n    z-index: 1;\n    box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;\n    \n}\n\n.header-mobile {\n    width: 100%;\n}\n\n#menu-button {\n    padding-left: 20px;\n    font-size: 25px;\n    color: var(--grey);\n}\n\n\n.sidebar {\n    flex-direction: column;\n    height: 100vh;\n    background-color: var(--blue);\n    box-shadow: 25px 0 20px -20px rgba(0, 0, 0, 0.45), -25px 0 20px -20px rgba(0, 0, 0, 0.45);\n}\n\n.sidebar-hide {\n    display: none\n}\n\n.sidebar-show {\n    display: flex;\n}\n\n.container {\n    display: flex;\n    z-index: 0;\n    width: 70%;\n}\n\n.main-mobile {\n    width: 100vw;\n    flex-direction: column;\n    height: 100vh;\n    flex: 1;\n    padding: 0;\n}\n\n\n\n.sidebar-show {\n    -webkit-transform: translateX(0);\n    transform: translateX(0);\n    display: flex;\n  }\n\n.sidebar-hide {\n    -webkit-transform: translateX(-1000px);\n    transform: translateX(-1000px);\n    display: none;\n}\n\n.material-symbols-outlined {\n    cursor: pointer;\n}\n\n.static-list-item {\n    display: inline-flex;\n    flex-direction: row-reverse;\n    justify-content: flex-end;\n    gap: 20px;\n    padding: 10px;\n    padding-left: 20px;\n    color: var(--grey);\n    font-size: 25px;\n    align-items: center;\n\n}\n\n.static-list-item:hover {\n    background-color: var(--grey-highlight);\n}\n\n.nav-static {\n    display: flex;\n    flex-direction: column;\n    padding-top: 30px;\n}\n\na {\n    text-decoration:none;\n    color: var(--grey);\n }\n\n\n\n.main {\n    flex: 1;\n    /* background-color: var(--grey); */\n    background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n    width: 100vw;\n    flex-direction: column;\n    height: 100vh;\n    flex: 1;\n    padding: 0;\n\n}\n\n.nav-project-header {\n    display:flex;\n    margin: 20px;\n    margin-top: 40px;\n    justify-content: space-between;\n    align-items: center;\n    color: var(--grey);\n    font-size: 20px;\n    padding-bottom: 5px;\n    border-bottom: 2px solid var(--grey);\n}\n\n.active-project:hover{\n    background-color: var(--grey-highlight);\n}\n\n\n\n.active-project {\n    display: flex;\n    justify-content: space-between;\n    padding: 10px 20px 10px 20px;\n    font-size: 20px;\n    align-items: center\n}\n\n.modal-div {\n    display: flex;\n    justify-content: space-between;\n    gap: 5px;\n    align-items: center\n}\n\n\n.modal-display {\n    position:absolute;\n    z-index: 10;\n    display: flex;\n    justify-content: center;\n    align-items: flex-start;\n    position: fixed;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    background-color: #121e2281\n}\n\n.new-project-modal-container {\n    display: flex;\n    flex-direction: column;\n    min-width: 400px;\n    margin-top: 180px;\n    height: auto;\n    background-color: var(--grey);\n    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n    color: var(--blue);\n}\n\n.modal-title-div {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 15px;\n    font-size: 20px;\n    background-image: var(--salmon-gradient);\n    color: var(--black);\n}\n\n.modal-body, .modal-submit{\n    margin: 20px;\n    display: flex;\n    flex-direction: column;\n    gap: 5px;\n    background-color: var(--);\n}\n\ninput {\n    padding-top: 5px;\n    height: 45px;\n    padding: 0 12px;\n    background-color: var(--grey);\n    border:none;\n    border-bottom:1px solid #757575;\n    -webkit-transition: all .2s;\n    transition: all .2s;\n}\n\ninput:focus     { outline:none; }\n\ninput[type=\"checkbox\"] {\n    float: right;\n    width: 20px;\n  }\n\n.check-group {\n    display: flex;\n    justify-content:space-between;\n    align-items: center;\n}\n\n\n.modal-submit {\n    flex-direction: row;\n    justify-content: flex-end;\n}\n\n.cancel-button, .submit-button {\n    border: solid 1px rgba(0,0,0,.15);\n    padding: 8px 12px;\n    cursor: pointer;\n    border-radius: 6px;\n}\n\n.submit-button {\n    background-color: var(--salmon);\n}\n\n.main {\n    padding: 20px;\n    color: var(--blue)\n}\n\n.project-title { \n    font-size: 25px;\n    padding-bottom: 20px;\n}\n\n.task-div {\n    display: flex;\n    justify-content: space-evenly;\n    align-items: center;\n    gap: 5px;\n\n}\n\n.task-project-name {\n    flex: 1;\n}\n\n.new-task-div {\n    display: flex;\n    align-items: center;\n    gap: 5px;\n\n}\n\n.task-description {\n    margin-top: -10px;\n    margin-left: 25px;\n    font-size: 12px;\n    padding-bottom: 0;\n}\n\n.task-div-top {\n}\n\n.task-div-top:hover {\n    background-color: var(--blue-highlight)\n}\n\n.completed {\n    position: relative;\n}\n.completed:after {\n    position: absolute;\n    z-index: 1;\n    content: \"\";\n    left: 5%;\n    top: 50%;\n    right: 0;\n    border-top: 3px solid;\n    border-color: inherit;\n    text-decoration: line-through;\n    \n}\n\n.strikethrough {\n    text-decoration: line-through;\n}\n\n.invalid {\n    border-bottom: 2px solid var(--salmon)\n}\n\n.hint {\n    font-size: 10px;\n    font-weight: bold;\n    animation: shake .3s;\n    color: var(--yellow);\n}\n\n@keyframes shake {\n \t25% { transform: translateX(4px) }\n\t50% { transform: translateX(-4px) }\n\t75% { transform: translateX(4px) }\n}\n\n\n/* Responsiveness */\n\n@media only screen and (max-width: 768px) {\n    .header, .container {\n      width: 100%\n    }\n  }", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,8GAA8G;IAC9G,iBAAiB;IACjB,gBAAgB;IAChB,eAAe;IACf,2BAA2B;IAC3B,eAAe;IACf,2BAA2B;IAC3B,gBAAgB;IAChB,gBAAgB;AACpB;;AAEA;IACI,SAAS;IACT,+BAA+B;IAC/B,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,wCAAwC;IACxC,YAAY;IACZ,eAAe;IACf,UAAU;IACV,aAAa;IACb,yBAAyB;IACzB,mBAAmB;IACnB,UAAU;IACV,uHAAuH;;AAE3H;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,eAAe;IACf,kBAAkB;AACtB;;;AAGA;IACI,sBAAsB;IACtB,aAAa;IACb,6BAA6B;IAC7B,yFAAyF;AAC7F;;AAEA;IACI;AACJ;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,UAAU;IACV,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,sBAAsB;IACtB,aAAa;IACb,OAAO;IACP,UAAU;AACd;;;;AAIA;IACI,gCAAgC;IAChC,wBAAwB;IACxB,aAAa;EACf;;AAEF;IACI,sCAAsC;IACtC,8BAA8B;IAC9B,aAAa;AACjB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,oBAAoB;IACpB,2BAA2B;IAC3B,yBAAyB;IACzB,SAAS;IACT,aAAa;IACb,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;IACf,mBAAmB;;AAEvB;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,iBAAiB;AACrB;;AAEA;IACI,oBAAoB;IACpB,kBAAkB;CACrB;;;;AAID;IACI,OAAO;IACP,mCAAmC;IACnC,yDAA+C;IAC/C,YAAY;IACZ,sBAAsB;IACtB,aAAa;IACb,OAAO;IACP,UAAU;;AAEd;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,gBAAgB;IAChB,8BAA8B;IAC9B,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;IACf,mBAAmB;IACnB,oCAAoC;AACxC;;AAEA;IACI,uCAAuC;AAC3C;;;;AAIA;IACI,aAAa;IACb,8BAA8B;IAC9B,4BAA4B;IAC5B,eAAe;IACf;AACJ;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,QAAQ;IACR;AACJ;;;AAGA;IACI,iBAAiB;IACjB,WAAW;IACX,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,eAAe;IACf,OAAO;IACP,QAAQ;IACR,WAAW;IACX,YAAY;IACZ;AACJ;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,gBAAgB;IAChB,iBAAiB;IACjB,YAAY;IACZ,6BAA6B;IAC7B,2CAA2C;IAC3C,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,aAAa;IACb,eAAe;IACf,wCAAwC;IACxC,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB,QAAQ;IACR,yBAAyB;AAC7B;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,eAAe;IACf,6BAA6B;IAC7B,WAAW;IACX,+BAA+B;IAC/B,2BAA2B;IAC3B,mBAAmB;AACvB;;AAEA,kBAAkB,YAAY,EAAE;;AAEhC;IACI,YAAY;IACZ,WAAW;EACb;;AAEF;IACI,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;AACvB;;;AAGA;IACI,mBAAmB;IACnB,yBAAyB;AAC7B;;AAEA;IACI,iCAAiC;IACjC,iBAAiB;IACjB,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI,+BAA+B;AACnC;;AAEA;IACI,aAAa;IACb;AACJ;;AAEA;IACI,eAAe;IACf,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;IACnB,QAAQ;;AAEZ;;AAEA;IACI,OAAO;AACX;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,QAAQ;;AAEZ;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;IACjB,eAAe;IACf,iBAAiB;AACrB;;AAEA;AACA;;AAEA;IACI;AACJ;;AAEA;IACI,kBAAkB;AACtB;AACA;IACI,kBAAkB;IAClB,UAAU;IACV,WAAW;IACX,QAAQ;IACR,QAAQ;IACR,QAAQ;IACR,qBAAqB;IACrB,qBAAqB;IACrB,6BAA6B;;AAEjC;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI;AACJ;;AAEA;IACI,eAAe;IACf,iBAAiB;IACjB,oBAAoB;IACpB,oBAAoB;AACxB;;AAEA;EACE,MAAM,2BAA2B;CAClC,MAAM,4BAA4B;CAClC,MAAM,2BAA2B;AAClC;;;AAGA,mBAAmB;;AAEnB;IACI;MACE;IACF;EACF","sourcesContent":[":root {\n    --salmon: #369a7e;\n    --salmon-gradient: linear-gradient(90deg, rgba(84,90,92,1) 0%, rgba(54,154,126,1) 60%, rgba(0,212,255,1) 100%);\n    --yellow: #F87575;\n    --green: #B8F2E6;\n    --blue: #545a5c;\n    --blue-highlight: #545a5c83;\n    --grey: #e9e9e9;\n    --grey-highlight: #e9e9e970;\n    --black: #2D2D34;\n    --white: #ffffff;\n}\n\nbody {\n    margin: 0;\n    font-family: 'Tillana', cursive;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.header {\n    background-image: var(--salmon-gradient);\n    height: 60px;\n    font-size: 20px;\n    width: 70%;\n    display: flex;\n    justify-items: flex-start;\n    align-items: center;\n    z-index: 1;\n    box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;\n    \n}\n\n.header-mobile {\n    width: 100%;\n}\n\n#menu-button {\n    padding-left: 20px;\n    font-size: 25px;\n    color: var(--grey);\n}\n\n\n.sidebar {\n    flex-direction: column;\n    height: 100vh;\n    background-color: var(--blue);\n    box-shadow: 25px 0 20px -20px rgba(0, 0, 0, 0.45), -25px 0 20px -20px rgba(0, 0, 0, 0.45);\n}\n\n.sidebar-hide {\n    display: none\n}\n\n.sidebar-show {\n    display: flex;\n}\n\n.container {\n    display: flex;\n    z-index: 0;\n    width: 70%;\n}\n\n.main-mobile {\n    width: 100vw;\n    flex-direction: column;\n    height: 100vh;\n    flex: 1;\n    padding: 0;\n}\n\n\n\n.sidebar-show {\n    -webkit-transform: translateX(0);\n    transform: translateX(0);\n    display: flex;\n  }\n\n.sidebar-hide {\n    -webkit-transform: translateX(-1000px);\n    transform: translateX(-1000px);\n    display: none;\n}\n\n.material-symbols-outlined {\n    cursor: pointer;\n}\n\n.static-list-item {\n    display: inline-flex;\n    flex-direction: row-reverse;\n    justify-content: flex-end;\n    gap: 20px;\n    padding: 10px;\n    padding-left: 20px;\n    color: var(--grey);\n    font-size: 25px;\n    align-items: center;\n\n}\n\n.static-list-item:hover {\n    background-color: var(--grey-highlight);\n}\n\n.nav-static {\n    display: flex;\n    flex-direction: column;\n    padding-top: 30px;\n}\n\na {\n    text-decoration:none;\n    color: var(--grey);\n }\n\n\n\n.main {\n    flex: 1;\n    /* background-color: var(--grey); */\n    background-image: url(\"../src/white_paper.jpg\");\n    width: 100vw;\n    flex-direction: column;\n    height: 100vh;\n    flex: 1;\n    padding: 0;\n\n}\n\n.nav-project-header {\n    display:flex;\n    margin: 20px;\n    margin-top: 40px;\n    justify-content: space-between;\n    align-items: center;\n    color: var(--grey);\n    font-size: 20px;\n    padding-bottom: 5px;\n    border-bottom: 2px solid var(--grey);\n}\n\n.active-project:hover{\n    background-color: var(--grey-highlight);\n}\n\n\n\n.active-project {\n    display: flex;\n    justify-content: space-between;\n    padding: 10px 20px 10px 20px;\n    font-size: 20px;\n    align-items: center\n}\n\n.modal-div {\n    display: flex;\n    justify-content: space-between;\n    gap: 5px;\n    align-items: center\n}\n\n\n.modal-display {\n    position:absolute;\n    z-index: 10;\n    display: flex;\n    justify-content: center;\n    align-items: flex-start;\n    position: fixed;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    background-color: #121e2281\n}\n\n.new-project-modal-container {\n    display: flex;\n    flex-direction: column;\n    min-width: 400px;\n    margin-top: 180px;\n    height: auto;\n    background-color: var(--grey);\n    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n    color: var(--blue);\n}\n\n.modal-title-div {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 15px;\n    font-size: 20px;\n    background-image: var(--salmon-gradient);\n    color: var(--black);\n}\n\n.modal-body, .modal-submit{\n    margin: 20px;\n    display: flex;\n    flex-direction: column;\n    gap: 5px;\n    background-color: var(--);\n}\n\ninput {\n    padding-top: 5px;\n    height: 45px;\n    padding: 0 12px;\n    background-color: var(--grey);\n    border:none;\n    border-bottom:1px solid #757575;\n    -webkit-transition: all .2s;\n    transition: all .2s;\n}\n\ninput:focus     { outline:none; }\n\ninput[type=\"checkbox\"] {\n    float: right;\n    width: 20px;\n  }\n\n.check-group {\n    display: flex;\n    justify-content:space-between;\n    align-items: center;\n}\n\n\n.modal-submit {\n    flex-direction: row;\n    justify-content: flex-end;\n}\n\n.cancel-button, .submit-button {\n    border: solid 1px rgba(0,0,0,.15);\n    padding: 8px 12px;\n    cursor: pointer;\n    border-radius: 6px;\n}\n\n.submit-button {\n    background-color: var(--salmon);\n}\n\n.main {\n    padding: 20px;\n    color: var(--blue)\n}\n\n.project-title { \n    font-size: 25px;\n    padding-bottom: 20px;\n}\n\n.task-div {\n    display: flex;\n    justify-content: space-evenly;\n    align-items: center;\n    gap: 5px;\n\n}\n\n.task-project-name {\n    flex: 1;\n}\n\n.new-task-div {\n    display: flex;\n    align-items: center;\n    gap: 5px;\n\n}\n\n.task-description {\n    margin-top: -10px;\n    margin-left: 25px;\n    font-size: 12px;\n    padding-bottom: 0;\n}\n\n.task-div-top {\n}\n\n.task-div-top:hover {\n    background-color: var(--blue-highlight)\n}\n\n.completed {\n    position: relative;\n}\n.completed:after {\n    position: absolute;\n    z-index: 1;\n    content: \"\";\n    left: 5%;\n    top: 50%;\n    right: 0;\n    border-top: 3px solid;\n    border-color: inherit;\n    text-decoration: line-through;\n    \n}\n\n.strikethrough {\n    text-decoration: line-through;\n}\n\n.invalid {\n    border-bottom: 2px solid var(--salmon)\n}\n\n.hint {\n    font-size: 10px;\n    font-weight: bold;\n    animation: shake .3s;\n    color: var(--yellow);\n}\n\n@keyframes shake {\n \t25% { transform: translateX(4px) }\n\t50% { transform: translateX(-4px) }\n\t75% { transform: translateX(4px) }\n}\n\n\n/* Responsiveness */\n\n@media only screen and (max-width: 768px) {\n    .header, .container {\n      width: 100%\n    }\n  }\n\n@import url('https://fonts.googleapis.com/css2?family=Concert+One&family=Tillana&display=swap');"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "responsiveSidebar": () => (/* binding */ responsiveSidebar)
/* harmony export */ });
...
let renderTaskList = (projectId, complete) => {
    ...
    for (let i = 0; i < projectList[projectId].tasks.length; i++ ) 
    {
        ...
        dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(projectList[projectId].tasks[i].dueDate), 'dd MMM yyyy');
...
function filterMain(mode) {
    ...
    if (mode == "completed") {
        ...
        mainScreen.querySelectorAll(".due-date").forEach(e => {
            ...
            if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(e.textContent))) {
                e.parentNode.parentNode.remove();
            }
            else {
                const result = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(e.textContent), new Date());
        ...
        mainScreen.querySelectorAll(".due-date").forEach(e => {
            ...
            if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(e.textContent))) {
                e.parentNode.parentNode.remove();
            }
        })
...
let clickHandler = (
    ...
    if (clickOrigin == "delete") {
        ...
        (0,_dom_helper__WEBPACK_IMPORTED_MODULE_0__.filterMain)("week")
    }
        ...
        (0,_dom_helper__WEBPACK_IMPORTED_MODULE_0__.filterMain)("today")
    }
...
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage */ "./src/storage.js");
    ...
    let projectList = [];
    if ((0,_storage__WEBPACK_IMPORTED_MODULE_0__.retrieveLocalstorage)(projectList)) {
        projectList = (0,_storage__WEBPACK_IMPORTED_MODULE_0__.retrieveLocalstorage)(projectList)
    };
    ...
    function createProject(title) {
        ...
        (0,_storage__WEBPACK_IMPORTED_MODULE_0__.updateLocalStorage)(projectList);
    };
    ...
    function createTask(title, description, dueDate, priority, projectIndex) {
        let newTask = new task(title, description, (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate), priority, projectIndex);
    ...
    function updateTask(title, description, dueDate, priority, projectIndex, taskIndex) {
        ...
        projectList[projectIndex].tasks[taskIndex].dueDate = (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate);
...
/* harmony export */ });
/* harmony import */ var _projects_tasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projects-tasks */ "./src/projects-tasks.js");
...
(0,_dom_helper__WEBPACK_IMPORTED_MODULE_1__.renderProjectSidebar)();
(0,_dom_helper__WEBPACK_IMPORTED_MODULE_1__.renderTaskList)();
